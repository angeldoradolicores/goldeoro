        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <p className="text-titanium mt-4 text-sm md:text-base font-sans font-light tracking-wide max-w-xl mx-auto leading-relaxed">
              Regulaciones de uso, condiciones de compra y políticas legales de Gol de Oro.
            </p>
          </motion.div>
          ...
          <div className="space-y-8 text-titanium leading-relaxed bg-carbon p-8 rounded-none border border-steel/30 shadow-2xl mb-12 relative font-sans font-light">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm">
                Este sitio web es operado por Gol de Oro. Al visitar nuestro sitio y comprar nuestros productos, aceptas quedar vinculado por los siguientes términos y condiciones de servicio.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs md:text-sm">
                Realizamos despachos nacionales de forma exclusiva a través de Interrapidísimo. El plazo estimado para la entrega es de 3 a 5 días hábiles a partir de la confirmación del despacho. El costo de envío es gratuito para compras superiores a $300.000 COP.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs md:text-sm">
                Los productos deben estar con sus etiquetas puestas, empaque original y sin signos de uso para ser elegibles para cambios.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs md:text-sm">
                Todo el contenido disponible en este sitio, incluidos textos, gráficos, logotipos, imágenes y códigos de programación, es propiedad exclusiva de Gol de Oro y está protegido por las leyes de propiedad intelectual internacionales y de la República de Colombia.
              </p>
            </div>
          </div>
          ...
          <div className="text-center bg-carbon rounded-none p-8 border border-steel/30 shadow-2xl">
            ...
            <p className="text-titanium text-xs md:text-sm mb-6 max-w-md mx-auto font-sans font-light leading-relaxed">
              Comunícate con nosotros por correo electrónico a goldeorocoll@gmail.com o escribiendo a nuestro WhatsApp.
            </p>
            <a
