...
('Crown Elite Black', 'crown-elite-black', 'Gorra premium de edicion limitada con bordado en oro de 24k. Confeccionada en algodon egipcio de la mas alta calidad con acabados de lujo. El diseno exclusivo representa la esencia del streetwear colombiano.', 289000, 350000, 'Premium', 15, true, true, ARRAY['https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=800&q=80', 'https://images.unsplash.com/photo-1575428652377-a2d80e2277fc?w=800&q=80'], ARRAY['Negro', 'Dorado', 'Blanco'], ARRAY['S', 'M', 'L', 'XL']),
